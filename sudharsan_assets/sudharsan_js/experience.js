...
const exp = [
  ...
  },
  {
    ...
    cardImage: "sudharsan_assets/sudharsan_images/experience-page/mphasis.jpg",
    place: "Mphasis - Bangalore, India",
    time: "(Apr, 2012 - Mar, 2015)",
    desp: "<li>Install, configure and maintain server operating systems and repair server (Linux,VMWare).</li><li>Provide a point of escalation and support to the L1 engineers.</li> <li>Monitor servers and troubleshoot issues.</li><li>Create and modify shell scripts to perform tasks.</li>",
  },
];
...
const volunteershipcards = [
  {
    ...
    cardImage: "sudharsan_assets/sudharsan_images/experience-page/opensource.jpg",
    description:
      "My Open Source information will be update soon.....! keep smile",
  },
  ]
 /* {
